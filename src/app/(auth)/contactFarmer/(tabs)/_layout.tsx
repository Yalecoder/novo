...
const Layout = () => {
    ...
    return(
        ...
        <MaterialTopTabs screenOptions={{tabBarStyle: { backgroundColor: '#5CA439' }, tabBarIndicatorStyle:{backgroundColor:'#fff', height:6}}}>
          ...
          <MaterialTopTabs.Screen name="index" options={{title:'Mercados',tabBarLabelStyle:{color:"#fff", fontWeight:'bold'}}} />
          <MaterialTopTabs.Screen name="inde" options={{title:'Produtores',tabBarLabelStyle:{color:"#fff", fontWeight:'bold'}}} />
